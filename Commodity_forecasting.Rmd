...
#Looking at trends and Seasonality Sugar
...
#Looking at trends and Seasonality
...
#Looking at trends and Seasonality Aluminum

autoplot(decompose((alum_ts)),main="") 
## Seasonality shown in plot
...
#Looking at trends and Seasonality Soybean
...
#Looking at trends and Seasonality Soybean oil
...
#Looking at trends and Seasonality Corn
...
#Looking at trends and Seasonality Cotton
...
# EDA Results
```{r}
# There seems to be major economic events that impact the prices of every commodity. These include sharp increases and decreases in prices before a leveling out. Price of commodities is impacted by seasonality as there are significant fluctuations of price throughout the year. However, there does not seem to be significant price changes based on weekday. Commodity pricing did see some sharp changes during the years 2008 to 2012, which deserves additional exploration.
...
#Each of the plots showed seasonality in there patterns suggesting predictable fluctuations in demand based on the time of year. Sharing this with Swire can help with resource planning and understanding commodity price behavior. 
